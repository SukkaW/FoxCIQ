...
.PHONY: build build-power build-heart dev dev-power dev-heart sim clean help

help:
	@echo "make build        Build both FoxPower and FoxHeart"
...
clean:
	rm -rf FoxPower/bin FoxHeart/bin
